...
namespace Antmicro.Renode.Peripherals.CPU
{
    ...
    public partial class STM8 : TranslationCPU
    {
        public STM8(string cpuType, IMachine machine)
            : base(cpuType, machine, Endianess.LittleEndian)
        {
        }

        public override string Architecture     => "stm8";
        public override string GDBArchitecture  => "stm8";
        public override string[] AllLLVMTriples => new[] { "stm8" };
        public override string LLVMModel        => "stm8";
        ...
        public override void OnGPIO(int number, bool value)
        {
            ...
            case 0:
                ...
                break;
            default:
                this.Log(LogLevel.Warning, "STM8: GPIO index {0} out of range", number);
                break;
            }
        }
        ...
        {
            this.NoisyLog("STM8: Acknowledged interrupt {0}", interruptNumber);
        }
        ...
        {
            IsHalted = true;
            this.NoisyLog("STM8: CPU entered HALT");
        }
