...
//
// Microchip PIC18 8-bit MCU emulation core.
//
// Architecture notes:
//   - 16-bit instruction words (some 2-word 32-bit)
//   - WREG + file registers with BSR banking
//   - 21-bit PC, 31-level hardware stack
//   - Data memory: Access bank + banked registers
//
using System;
...
namespace Antmicro.Renode.Peripherals.CPU
{
    ...
    public partial class PIC18 : TranslationCPU
    {
        public PIC18(string cpuType, IMachine machine)
            : base(cpuType, machine, Endianess.LittleEndian)
        {
        }

        public override string Architecture     => "pic18";
        public override string GDBArchitecture  => "pic18";
        public override string[] AllLLVMTriples => new[] { "pic18" };
        public override string LLVMModel        => "pic18";
        ...
        public override void OnGPIO(int number, bool value)
        {
            ...
            case 0:
                ...
                break;
            default:
                this.Log(LogLevel.Warning, "PIC18: GPIO index {0} out of range", number);
                break;
            }
        }
        ...
        {
            this.NoisyLog("PIC18: Acknowledged interrupt {0}", interruptNumber);
        }
        ...
        {
            IsHalted = true;
            this.NoisyLog("PIC18: CPU entered SLEEP");
        }
...
#pragma warning restore 649
        ...
        {
            { 0, "Reset" },
            { 8, "High-priority interrupt" },
            { 24, "Low-priority interrupt" },
