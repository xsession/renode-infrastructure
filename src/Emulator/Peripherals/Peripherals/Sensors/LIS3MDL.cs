...
{
    // ST LIS3MDL - 3-axis magnetometer (I2C)
    public class LIS3MDL : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public LIS3MDL()
        {
        ...
        {
            Registers.ChipId.Define(this, 0x3D);
