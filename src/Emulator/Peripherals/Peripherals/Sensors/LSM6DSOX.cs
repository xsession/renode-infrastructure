...
{
    // ST LSM6DSOX - 6-axis IMU with MLC (I2C)
    public class LSM6DSOX : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public LSM6DSOX()
        {
        ...
        {
            Registers.ChipId.Define(this, 0x6C);
