...
{
    // Bosch BMA400 - 3-axis accelerometer (I2C)
    public class BMA400 : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public BMA400()
        {
        ...
        {
            Registers.ChipId.Define(this, 0x90);
