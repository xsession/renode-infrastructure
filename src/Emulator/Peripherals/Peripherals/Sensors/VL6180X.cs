...
{
    // ST VL6180X - proximity/ALS sensor (I2C)
    public class VL6180X : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>
    {
        public VL6180X()
        {
        ...
        public int DistanceMm { get; set; } = 100;
