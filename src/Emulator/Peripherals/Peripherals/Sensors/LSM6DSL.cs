...
{
    // ST LSM6DSL - 6-axis IMU (I2C)
    public class LSM6DSL : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public LSM6DSL()
        {
        ...
        {
            Registers.WhoAmI.Define(this, 0x6A);
