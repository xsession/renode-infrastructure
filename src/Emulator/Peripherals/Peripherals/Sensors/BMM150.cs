...
{
    // Bosch BMM150 - 3-axis magnetometer (I2C)
    public class BMM150 : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public BMM150()
        {
        ...
        {
            Registers.ChipId.Define(this, 0x32);
