...
{
    // ST LSM303AGR - accelerometer (I2C)
    public class LSM303AGR_Accelerometer : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public LSM303AGR_Accelerometer()
        {
