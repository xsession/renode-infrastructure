...
{
    // InvenSense MPU-9250 - 9-axis IMU (I2C), WHO_AM_I=0x71
    public class MPU9250 : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public MPU9250()
        {
