...
{
    // NXP FXOS8700CQ - 6-axis accel+mag (I2C)
    public class FXOS8700 : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public FXOS8700()
        {
        ...
        {
            Registers.WhoAmI.Define(this, 0xC7);
