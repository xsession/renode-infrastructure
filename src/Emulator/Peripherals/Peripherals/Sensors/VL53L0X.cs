...
{
    // ST VL53L0X - Time-of-Flight distance sensor (I2C)
    public class VL53L0X : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>
    {
        public VL53L0X()
        {
        ...
        public int DistanceMm { get; set; } = 200;
        ...
        {
            Registers.ModelId.Define(this, 0xEE);
