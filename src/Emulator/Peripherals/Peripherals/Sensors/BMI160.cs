...
{
    // Bosch BMI160 - 6-axis IMU (I2C), Chip ID=0xD1
    public class BMI160 : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public BMI160()
        {
        ...
        {
            Registers.ChipId.Define(this, 0xD1);
