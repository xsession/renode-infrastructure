...
{
    // ST VL53L4CD - proximity/ToF sensor (I2C)
    public class VL53L4CD : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public VL53L4CD()
        {
        ...
        {
            Registers.WhoAmI.Define(this, 0xEB);
