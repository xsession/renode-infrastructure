...
{
    // ST LIS2DH12 - 3-axis accelerometer (I2C)
    public class LIS2DH12 : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public LIS2DH12()
        {
        ...
        {
            Registers.WhoAmI.Define(this, 0x33);
