...
{
    // ST LSM303AGR - magnetometer (I2C)
    public class LSM303AGR_Magnetic : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public LSM303AGR_Magnetic()
        {
        ...
        {
            Registers.ChipId.Define(this, 0x40);
