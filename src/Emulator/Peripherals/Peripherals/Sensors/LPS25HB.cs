...
{
    // ST LPS25HB - MEMS pressure sensor (I2C), WHO_AM_I=0xBD
    public class LPS25HB : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public LPS25HB()
        {
