...
{
    // ST LPS28DFW - absolute pressure sensor (I2C)
    public class LPS28DFW : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public LPS28DFW()
        {
        ...
        {
            Registers.WhoAmI.Define(this, 0xB4);
