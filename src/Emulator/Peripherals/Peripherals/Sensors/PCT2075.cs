...
{
    // NXP PCT2075 - digital temperature sensor (I2C)
    public class PCT2075 : II2CPeripheral, IProvidesRegisterCollection<ByteRegisterCollection>, ITemperatureSensor
    {
        public PCT2075()
        {
        ...
        {
            Registers.WhoAmI.Define(this, 0x00);
